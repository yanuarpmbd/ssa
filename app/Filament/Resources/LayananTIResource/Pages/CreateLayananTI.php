...
namespace App\Filament\Resources\LayananTIResource\Pages;

use App\Filament\Resources\LayananTIResource;
use Illuminate\Support\Str;
use Sgcomptech\FilamentTicketing\Events\NewTicket;
use Filament\Resources\Pages\CreateRecord;

class CreateLayananTI extends CreateRecord
{
    protected static string $resource = LayananTIResource::class;
